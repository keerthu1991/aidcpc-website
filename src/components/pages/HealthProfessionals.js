...
export default function HealthProfessionals(){
    return(
      <div className="healthprofessionals">
        ...
        <Container>
        <CardDeck>
        <CardInfo title="Dr.Charumathi Rathnakumar" description="Dr. Charumathi Rathnakumar is an Infectious Disease Specialist in Edison, New Jersey. 
    ...
    image="images/charu.jpg" href="https://www.healthgrades.com/physician/dr-charumathi-rathnakumar-3kn8v" buttonname="View Profile"/>
    <CardInfo title="Dr.Charumathi Rathnakumar" description="Dr. Charumathi Rathnakumar is an Infectious Disease Specialist in Edison, New Jersey. 
    She graduated with honors in 1993. 
    Having more than 23 years of diverse experiences, especially in Infectious Disease, Internal Medicine, 
    Dr. Charumathi Rathnakumar affiliates with many hospitals including Community Hospital Group Inc, 
