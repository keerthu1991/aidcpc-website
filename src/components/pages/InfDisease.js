...
export default function InfDisease(){
    return(
        ...
        from solving the most complex infectious disease cases to offering in-office infusion services 365 days a year. 
        Our experts are available in virtually any location in which patients require care. 
        Health care is rapidly changing and AIDC has been a leader in the field for implementing cutting-edge treatments, 
        state-of-the-art technology, modern electronic medical record (EMR) systems and innovative research. 
        Our reputation is well-deserved, with virtually all AIDC physicians having achieved 
        recognition for excellence throughout our more than 20 years of uninterrupted service to NJ residents. 
