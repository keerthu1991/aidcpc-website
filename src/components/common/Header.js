      ...
      <ReactBootstrap.Navbar.Collapse id="basic-navbar-nav">
        <ReactBootstrap.Nav className="mr-auto">
          <ReactBootstrap.NavDropdown title="About Us" id="basic-nav-dropdown">
            <ReactBootstrap.NavDropdown.Item href="/aidcpc">AIDC</ReactBootstrap.NavDropdown.Item>
          ...
          <ReactBootstrap.NavDropdown title="Services" id="basic-nav-dropdown">
            <ReactBootstrap.NavDropdown.Item href="/services">ID CARE-DISEASES/TREATMENT PROVIDED</ReactBootstrap.NavDropdown.Item>
          </ReactBootstrap.NavDropdown>
          ...
          <ReactBootstrap.NavDropdown title="Patient Help" id="basic-nav-dropdown">
            ...
            <ReactBootstrap.NavDropdown.Item href="/insuranceaccepted">Insurance Accepted</ReactBootstrap.NavDropdown.Item>
          </ReactBootstrap.NavDropdown>
